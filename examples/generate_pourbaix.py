...
for metal in metal_list:
    for activity in activity_list:
        for ligand_conc in ligand_concentration_list:
            ...
            plotter = GridPlotter(pH_range, V_range, metal_data, grid_size, save_fig=True, dir = 'activity_test')
            ...
            # Optional: Save region data
            # with open(f"data/{metal}_stable_regions.json", "w") as f:
